...
namespace CarLogin.Services
{
    public class CarService
    {
        ...
        {
            MongoClient client = new MongoClient(config.GetConnectionString("CarGalleryAppDb"));
            IMongoDatabase database = client.GetDatabase("CarGalleryAppDb");
